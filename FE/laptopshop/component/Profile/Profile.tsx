...
export default function UserProfile() {
    ...
    return (
      <div className=" w-full lg:w-[280px] flex-shrink-0">
        ...
        >
          ...
          >
            <div
              className="w-14 h-14 rounded-full bg-[#1A73E8] flex items-center justify-center text-white text-xl font-bold"
          ...
          <nav className="flex flex-col" style={{ gap: "8px" }}>
            {menuItems.map((item) => (
              ...
              >
                <span className="text-xl" style={{ marginRight: "12px" }}>
                  {item.icon}
                </span>
                {item.label}
              </button>
    ...
    <div className="animate-in fade-in duration-300 w-full">
      ...
      >
        <h2 className="text-2xl font-bold text-gray-900">
          Tổng quan tài khoản (My Dashboard)
        </h2>
        <button
          type="button"
          onClick={() => setActiveTab("profile")}
          className="bg-[#1A73E8] text-white text-sm font-bold rounded-lg shadow-md hover:bg-blue-600 transition-colors"
      ...
      >
        {/* Thẻ Thông tin hồ sơ */}
        <div
          className="bg-gray-50 border border-gray-200 text-gray-900 rounded-xl flex flex-col justify-center"
          style={{ padding: "20px" }}
        >
          <h3
        ...
        <div
          className="bg-gray-50 border border-gray-200 text-gray-900 rounded-xl flex flex-col justify-between"
          style={{ padding: "20px" }}
        >
          <div>
            <h3
          ...
          <button
            ...
            className="text-sm font-bold text-[#1A73E8] text-left hover:underline"
        ...
        <div
          className="bg-gray-50 border border-gray-200 text-gray-900 rounded-xl flex flex-col items-center justify-center text-center"
          style={{ padding: "20px" }}
        >
          <h3
            className="font-bold text-sm text-gray-500 w-full text-left"
            style={{ marginBottom: "8px" }}
          >
            SẢN PHẨM YÊU THÍCH
          </h3>
          <div
            className="text-4xl font-bold flex items-center text-gray-900"
            style={{ gap: "8px", margin: "16px 0" }}
          >
            ❤️ 5
          </div>
      ...
      <div className="flex flex-wrap" style={{ gap: "16px" }}>
        ...
        <button
          ...
          style={{ padding: "12px 20px" }}
        >
          <span style={{ marginRight: "8px" }}>❤️</span> Quản lý Danh sách yêu
          thích
        </button>
      </div>
    </div>
  ...
  const renderOrders = () => {
    ...
    return (
      <div className="animate-in fade-in duration-300 w-full">
        ...
        {/* Bộ lọc */}
        <div
          className="flex border-b border-gray-200 w-full flex-wrap text-sm sm:text-base"
          style={{ gap: "24px", marginBottom: "24px" }}
        >
          <button
            type="button"
            className="text-[#1A73E8] font-bold border-b-2 border-[#1A73E8]"
        ...
        {/* Tiêu đề bảng */}
        <div
          className="hidden md:flex text-gray-500 font-bold text-sm w-full"
          style={{ marginBottom: "12px", padding: "0 20px" }}
        >
        ...
        <div className="flex flex-col" style={{ gap: "16px" }}>
          {orders.map((order, idx) => (
            <div
              key={idx}
              className="bg-white border border-gray-200 rounded-xl flex flex-col md:flex-row md:items-center w-full hover:shadow-md transition-shadow"
              style={{ padding: "20px" }}
            >
              <div
                className="w-full md:w-[150px] font-bold text-gray-900 text-lg"
                style={{ marginBottom: "12px" }}
              >
                {order.id}
              </div>
              <div
                className="w-full md:w-[150px] text-gray-500 text-sm whitespace-pre-line"
                style={{ marginBottom: "12px" }}
              >
                {order.date}
              </div>
              ...
              >
                <span
                  className="rounded-full font-bold text-xs inline-block"
                  style={{
              ...
              <div
                className="flex-1 font-bold text-gray-900 text-lg"
                style={{ marginBottom: "12px" }}
              >
                {order.total}
              </div>
              ...
              <button
                ...
                style={{
                  padding: "8px 20px",
                  backgroundColor: order.btnBg || "#1A73E8",
                  color: order.btnText || "#FFFFFF",
                }}
              >
                Chi tiết
              </button>
        ...
        >
          <button
            className="bg-white border border-gray-300 text-gray-600 rounded-full font-bold hover:bg-gray-50"
            style={{ width: "40px", height: "40px" }}
          >
            &lt;
          </button>
          <button
            className="bg-[#1A73E8] shadow-md shadow-blue-500/20 text-white rounded-full font-bold"
            style={{ width: "40px", height: "40px" }}
          >
            1
          </button>
  ...
  const renderProfile = () => (
    <div className="animate-in fade-in duration-300 w-full text-gray-900">
      ...
      <div
        className="flex flex-col lg:flex-row border-t border-gray-200 w-full"
        style={{ paddingTop: "32px" }}
      >
        {/* CỘT TRÁI: FORM ĐIỀN */}
        <div
          className="flex-1 lg:border-r border-gray-200"
        ...
        >
          <div style={{ marginBottom: "24px", marginRight: "32px" }}>
            ...
            <input
              ...
              className="w-full bg-gray-50 border border-gray-200 text-gray-900 rounded-lg outline-none focus:border-[#10B981] focus:bg-white transition-colors"
          ...
          <div style={{ marginBottom: "32px", marginRight: "32px" }}>
            ...
            <div
              className="bg-white border border-gray-200 text-gray-900 rounded-lg flex items-center shadow-sm"
            ...
            <div
              className="bg-green-50 border-2 border-[#10B981] text-gray-900 rounded-lg flex items-center shadow-sm"
              style={{ padding: "12px 16px", marginBottom: "12px" }}
            >
          ...
          >
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              <input
                ...
                className="w-full bg-white border border-gray-200 text-gray-900 rounded-lg outline-none focus:border-[#10B981]"
                style={{ padding: "12px 16px" }}
              />
            </div>
          ...
          <div className="flex items-center" style={{ gap: "16px" }}>
            <button
              type="button"
              className="bg-[#1A73E8] hover:bg-blue-700 text-white font-bold rounded-lg shadow-md transition-all"
        ...
        >
          <div
            className="w-32 h-32 rounded-full bg-gray-200 flex items-center justify-center text-5xl font-bold text-gray-400 shadow-inner"
            style={{ marginBottom: "24px" }}
          >
            👤
          </div>
          <button
            type="button"
            className="border border-gray-300 bg-white text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-colors shadow-sm"
    ...
    return (
      <div className="animate-in fade-in duration-300 w-full">
        ...
        >
          ...
          <button
            type="button"
            className="text-[#1A73E8] font-bold text-sm hover:underline"
          >
        ...
        <div
          className="flex border-b border-gray-200 w-full flex-wrap"
          style={{ gap: "24px", marginBottom: "24px" }}
        >
          <button
            type="button"
        ...
        <div className="flex flex-col w-full" style={{ gap: "16px" }}>
          {notis.map((noti) => (
            <div
              key={noti.id}
              className={`rounded-xl border ${noti.unread ? "bg-blue-50 border-blue-200" : "bg-white border-gray-200"} flex items-start w-full hover:shadow-sm transition-shadow`}
              style={{ padding: "20px" }}
            >
              <div
              ...
              <div className="flex-1">
                <h4
                  className={`text-lg font-bold ${noti.unread ? "text-gray-900" : "text-gray-600"}`}
                  style={{ marginBottom: "4px" }}
                >
                  {noti.unread && (
                    <span
                      className="inline-block w-2 h-2 bg-[#1A73E8] rounded-full align-middle"
                ...
                {noti.unread && (
                  <button
                    type="button"
                    className="text-[#1A73E8] text-sm font-bold hover:underline"
                  >
                    Xem chi tiết
                  </button>
                )}
              ...
              <span
                className="text-sm text-[#1A73E8] font-bold whitespace-nowrap hidden sm:block"
  ...
  const renderFooter = () => {
    return (
      <div
        className="w-full bg-[#F3F4F6] border-t border-gray-200"
        style={{ padding: "40px 16px", marginTop: "auto" }}
      >
        <div
        ...
        >
          ...
          <div className="flex-1 text-center lg:text-left w-full">
            ...
            <p
              className="text-sm text-[#6B7280] mx-auto lg:mx-0"
          ...
          <div className="flex-1 flex justify-center w-full">
            <div
              className="flex items-center bg-white rounded-full w-full max-w-md shadow-sm border border-gray-200"
              style={{ padding: "6px" }}
            >
              <input
                type="email"
          ...
          <div
            className="flex-1 flex justify-center lg:justify-end items-center w-full"
            style={{ gap: "16px" }}
          >
            {/* Facebook */}
            <div
              className="bg-[#00B207] text-white rounded-full flex items-center justify-center cursor-pointer hover:opacity-80 transition-opacity shadow-sm"
              style={{ width: "40px", height: "40px" }}
            >
              <svg
                width="20"
            ...
            {/* Twitter */}
            <div
              className="text-gray-500 hover:text-[#00B207] cursor-pointer transition-colors flex items-center justify-center"
              style={{ width: "40px", height: "40px" }}
            >
              <svg
                width="22"
  ...
  switch (activeTab) {
    case "dashboard":
      rightContent = renderDashboard();
      break;
    case "orders":
      rightContent = renderOrders();
      break;
    case "profile":
      rightContent = renderProfile();
      break;
    case "notifications":
      rightContent = renderNotifications();
      break;
    default:
      rightContent = renderDashboard();
  }
