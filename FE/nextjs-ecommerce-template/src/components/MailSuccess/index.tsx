...
const MailSuccess = () => {
  return (
    <>
      <Breadcrumb title={"Gửi mail thành công"} pages={["Gửi mail thành công"]} />
          ...
          <div className="bg-white rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25">
            ...
            <div className="text-center">
              ...
              <p className="max-w-[491px] w-full mx-auto mb-7.5">
                Cảm ơn bạn đã liên hệ với chúng tôi. Chúng tôi thường xuyên kiểm tra
                email và sẽ phản hồi sớm nhất có thể.
              </p>
